...
class SEOCrew:
    ...
    def seo_expert(self):
        return Agent(
            role="SEO Specialist",
            goal="Analyze blog posts for SEO optimization and provide a score with detailed reasoning in korean. Be very very very demanding, don't give underserved good scores.",
    ...
    def seo_audit(self):
        return Task(
            description="""Analyze the blog post for SEO effectiveness and provide in korean:
