...
def update_status(status_container, event):
    status_messages ={
        ...
        "response.mcp_call.completed" : ("⚒ Called MCP tool", "complete"),
        "response.mcp_call.failed" : ("⚒ Error calling MCP tool", "complete"),
        "response.mcp_call.in_progress" : ("⚒ Calling MCP tool...", "running"),
        "response.mcp_list_tools.completed" : ("⚒ Listed MCP tools", "complete"),
        "response.mcp_list_tools.failed" : ("⚒ Error listing MCP tools", "complete"),
        "response.mcp_list_tools.in_progress" : ("⚒ Listing MCP tools", "running"),
...
async def run_agent(message):
    ...
    # https://github.com/leoncuhk/mcp-yahoo-finance
            ...
            tools=[
                ...
                HostedMCPTool(
                    tool_config={
                        ...
                        "server_description": "Use this to get the docs from sofrware projects.",
